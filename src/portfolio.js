...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate test Full Stack Software Engineer 🚀 (also a generic Coding Lover) having an experience of building web applications with Java / Maven / Grails / JavaScript / KnockoutJS and some other cool libraries and frameworks."
  ),
