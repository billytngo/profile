...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Engineer 🚀 having an experience of building web applications with Java / Maven / Grails / JavaScript / KnockoutJS and some other cool libraries and frameworks."
  ),
